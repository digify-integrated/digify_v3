...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const product_type_id   = document.getElementById('details-id')?.textContent.trim();

    const displayDetails = async () => {
        const transaction = 'fetch product type details';

        try {
            resetForm('product_type_form');
            ...
            if (data.success) {
                document.getElementById('product_type_name').value = data.productTypeName || '';
            }
    ...
    attachLogNotesHandler('#log-notes-main', '#details-id', 'product_type');
    displayDetails();
    ...
    document.addEventListener('click', async (event) => {
        ...
        const transaction = 'delete product type';
