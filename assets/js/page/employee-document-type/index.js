...
document.addEventListener('DOMContentLoaded', () => {
    ...
    initializeDatatable({
        ...
        transaction: 'generate employee document type table',
        columns: [
            { data: 'CHECK_BOX' },
            { data: 'EMPLOYEE_DOCUMENT_TYPE_NAME' }
        ],
        columnDefs: [
    ...
    document.addEventListener('click', async (event) => {
        ...
        const result = await Swal.fire({
            title: 'Confirm Multiple Employee Document Types Deletion',
            text: 'Are you sure you want to delete these employee document types?',
            icon: 'warning',
        ...
        try {
            ...
            employee_document_type_id.forEach(id => formData.append('employee_document_type_id[]', id));
            ...
            if (data.success) {
                ...
                reloadDatatable('#employee-document-type-table');
            }
