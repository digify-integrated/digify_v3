...
document.addEventListener('DOMContentLoaded', () => {
    const displayDetails = async () => {
        ...
        try {
            ...
            formData.append('address_type_id', address_type_id);
    ...
    attachLogNotesHandler('#log-notes-main', '#details-id', 'address_type');
    displayDetails();
    ...
    $('#address_type_form').validate({
        ...
        submitHandler: async (form, event) => {
            ...
            try {
                ...
                if (!response.ok) {
                    throw new Error(`Save address type failed with status: ${response.status}`);
                }
