...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const payment_method_id     = document.getElementById('details-id')?.textContent.trim();
    
    const displayDetails = async () => {
        const transaction = 'fetch payment method details';

        try {
            resetForm('payment_method_form');
    ...
    attachLogNotesHandler('#log-notes-main', '#details-id', 'payment_method');
    displayDetails();
    ...
    $('#payment_method_form').validate({
        ...
        messages: {
            payment_method_name: { required: 'Enter the display name' }
        },
        ...
        submitHandler: async (form, event) => {
            ...
            const transaction = 'save payment method';
    ...
    document.addEventListener('click', async (event) => {
        ...
        const transaction = 'delete payment method';
