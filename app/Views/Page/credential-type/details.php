<div class="card mb-10">
    <div class="card-header border-0">
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">Credential Type Details</h3>
        </div>
        <?php
            if ($permissions['delete'] > 0) {
                ...
                if ($permissions['delete'] > 0) {
                    $action .= '<div class="menu-item px-3">
                                    <a href="javascript:void(0);" class="menu-link px-3" id="delete-credential-type">
                                        Delete
                                    </a>
                                </div>';
                }
    ...
    <div class="card-body">
        <form id="credential_type_form" method="post" action="#">
            ...
            <div class="fv-row mb-4">
                <label class="fs-6 fw-semibold required form-label mt-3" for="credential_type_name">
                    Display Name
                </label>

                <input type="text" class="form-control" id="credential_type_name" name="credential_type_name" maxlength="100" autocomplete="off" <?php echo $disabled; ?>>
            </div>
        </form>
    </div>
