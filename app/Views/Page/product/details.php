<?php
    ...
    $archiveProduct    = $authentication->checkUserSystemActionPermission($userID, 11);
    $unarchiveProduct  = $authentication->checkUserSystemActionPermission($userID, 12);
...
<div class="d-flex flex-column flex-lg-row">
            ...
            <div class="card-body">
                <div class="d-flex flex-center flex-column py-5">
                    <div class="image-input image-input-outline mb-7" data-kt-image-input="true">
                        <div class="image-input-wrapper w-120px h-120px" id="product_image_thumbnail" style="background-image: url(./assets/images/default/default-avatar.jpg)"></div>
                    ...
                    <span class="fs-3 text-gray-800 fw-bold mb-3 text-center" id="product_name_summary">--</span>
                ...
                <div class="d-flex flex-stack fs-4 py-3">
                    ...
                    <?php
                        echo ($permissions['write'] > 0) ? '<span data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-original-title="Edit product details" data-kt-initialized="1">
        ...
        <div class="card pt-4 mb-6 mb-xl-9">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <?php
                        echo ($permissions['write'] > 0) ? '<button type="button" class="btn btn-light-primary btn-sm" id="add-language" data-bs-toggle="modal" data-bs-target="#product_language_modal">
                                                                Add Language
                                                            </button>' : '';
                    ?>
                </div>
    ...
    <div class="flex-lg-row-fluid ms-lg-15">
        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#product_document_tab" aria-selected="false" tabindex="-1" role="tab">Product Documents</a>
            </li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="product_document_tab" role="tabpanel">
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                <?php
                                    echo ($permissions['write'] > 0) ? '<button type="button" class="btn btn-light-primary" id="add-document" data-bs-toggle="modal" data-bs-target="#product_document_modal">
                                                                            Add Document
                                                                        </button>' : '';
                                ?>
                            </div>
                    ...
                    <div class="card-body pt-9">
                        <table class="table align-middle table-row-dashed fs-6 gy-5 gs-7" id="product-document-table">
                            <thead>
...
<div id="product_emergency_contact_modal" class="modal fade" tabindex="-1" aria-labelledby="product_emergency_contact_modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Product Emergency Contact</h3>
                <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                    <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>
                </div>
            </div>
            ...
            <div class="modal-body">
                <form id="product_emergency_contact_form" method="post" action="#">
                    <?= $security->csrfInput('product_emergency_contact_form'); ?>
                    <input type="hidden" id="product_emergency_contact_id" name="product_emergency_contact_id">
                    <div class="row mb-6">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                    <select id="relationship_id" name="relationship_id" data-dropdown-parent="#product_emergency_contact_modal" class="form-select" data-control="select2" data-allow-clear="false"></select>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                <button type="submit" form="product_emergency_contact_form" class="btn btn-primary" id="submit_product_emergency_contact">Save</button>
            </div>
        </div>
    </div>
</div>

<div id="product_license_modal" class="modal fade" tabindex="-1" aria-labelledby="product_license_modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Product License</h3>
                <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                    <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>
                </div>
            </div>
            ...
            <div class="modal-body">
                <form id="product_license_form" method="post" action="#">
                    <?= $security->csrfInput('product_license_form'); ?>
                    <input type="hidden" id="product_license_id" name="product_license_id">
                    <div class="row mb-6">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                <button type="submit" form="product_license_form" class="btn btn-primary" id="submit_product_license">Save</button>
            </div>
        </div>
    </div>
</div>

<div id="product_experience_modal" class="modal fade" tabindex="-1" aria-labelledby="product_experience_modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Product Work Experience</h3>
                <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                    <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>
                </div>
            </div>
            ...
            <div class="modal-body">
                <form id="product_experience_form" method="post" action="#">
                    <?= $security->csrfInput('product_experience_form'); ?>
                    <input type="hidden" id="product_experience_id" name="product_experience_id">
                    <div class="row mb-6">
                    ...
                    <div class="row mb-6">
                        <label class="col-lg-4 col-form-label required fw-semibold fs-6" for="product_experience_employment_type_id">Employment Type</label>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                    <select id="product_experience_employment_type_id" name="product_experience_employment_type_id" data-dropdown-parent="#product_experience_modal" class="form-select" data-control="select2" data-allow-clear="false"></select>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                    <select id="product_experience_start_month" name="product_experience_start_month" class="form-select" data-dropdown-parent="#product_experience_modal" data-control="select2" data-allow-clear="false">
                                        <option value="">--</option>
                                        <?php echo $systemHelper->generateMonthOptions(); ?>
                                    </select>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                    <select id="product_experience_start_year" name="product_experience_start_year" class="form-select" data-dropdown-parent="#product_experience_modal" data-control="select2" data-allow-clear="false">
                                        <option value="">--</option>
                                        <?php echo $systemHelper->generateYearOptions(date('Y'), date('Y', strtotime('-100 years'))); ?>
                                    </select>
                                </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                    <select id="product_experience_end_month" name="product_experience_end_month" class="form-select" data-dropdown-parent="#product_experience_modal" data-control="select2" data-allow-clear="false">
                                        <option value="">--</option>
                                        <?php echo $systemHelper->generateMonthOptions(); ?>
                                    </select>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                    <select id="product_experience_end_year" name="product_experience_end_year" class="form-select" data-dropdown-parent="#product_experience_modal" data-control="select2" data-allow-clear="false">
                                        <option value="">--</option>
                                       <?php echo $systemHelper->generateYearOptions(date('Y'), date('Y', strtotime('-100 years'))); ?>
                                    </select>
                                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                <button type="submit" form="product_experience_form" class="btn btn-primary" id="submit_product_experience">Save</button>
            </div>
        </div>
    </div>
</div>

<div id="product_document_modal" class="modal fade" tabindex="-1" aria-labelledby="product_document_modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Product Document</h3>
                <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                    <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>
                </div>
            </div>
            ...
            <div class="modal-body">
                <form id="product_document_form" method="post" action="#">
                    <?= $security->csrfInput('product_document_form'); ?>
                    <input type="hidden" id="product_document_id" name="product_document_id">
                    <div class="row mb-6">
                    ...
                    <div class="row mb-6">
                        <label class="col-lg-4 col-form-label required fw-semibold fs-6" for="product_document_type_id">Document Type</label>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                    <select id="product_document_type_id" name="product_document_type_id" data-dropdown-parent="#product_document_modal" class="form-select" data-control="select2" data-allow-clear="false"></select>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                <button type="submit" form="product_document_form" class="btn btn-primary" id="submit_product_document">Save</button>
            </div>
        </div>
    </div>
</div>

<div id="archive_product_modal" class="modal fade" tabindex="-1" aria-labelledby="archive_product_modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="archive_product_form" method="post" action="#">
                    <?= $security->csrfInput('archive_product_form'); ?>
                    <div class="row mb-6">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                    <select id="departure_reason_id" name="departure_reason_id" data-dropdown-parent="#archive_product_modal" class="form-select" data-control="select2" data-allow-clear="false"></select>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                <button type="submit" form="archive_product_form" class="btn btn-primary" id="submit_product_archive">Save</button>
            </div>
        </div>
    </div>
</div>
