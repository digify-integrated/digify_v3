<div class="card mb-10">
    <div class="card-header border-0">
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">Bank Account Type Details</h3>
        </div>
        <?php
            if ($permissions['delete'] > 0) {
                ...
                if ($permissions['delete'] > 0) {
                    $action .= '<div class="menu-item px-3">
                                    <a href="javascript:void(0);" class="menu-link px-3" id="delete-bank-account-type">
                                        Delete
                                    </a>
                                </div>';
                }
    ...
    <div class="card-body">
        <form id="bank-account-type-form" method="post" action="#">
            <div class="fv-row mb-4">
                ...
                <input type="text" class="form-control" id="bank_account_type_name" name="bank_account_type_name" maxlength="100" autocomplete="off" <?php echo $disabled; ?>>
            </div>
        </form>
    </div>
    ...
    <?php
        echo ($permissions['write'] > 0) ? ' <div class="card-footer d-flex justify-content-end py-6 px-9">
                                                ...
                                                <button type="submit" form="bank-account-type-form" class="btn btn-primary" id="submit-data">Save</button>
                                            </div>' : '';
    ?>
</div>
