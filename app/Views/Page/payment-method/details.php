<div class="card mb-10">
    <div class="card-header border-0">
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">Payment Method Details</h3>
        </div>
        <?php
            if ($permissions['delete'] > 0) {
                ...
                if ($permissions['delete'] > 0) {
                    $action .= '<div class="menu-item px-3">
                                    <a href="javascript:void(0);" class="menu-link px-3" id="delete-payment-method">
                                        Delete
                                    </a>
                                </div>';
                }
    ...
    <div class="card-body">
        <form id="payment_method_form" method="post" action="#">
            ...
            <div class="fv-row mb-4">
                ...
                <input type="text" class="form-control" id="payment_method_name" name="payment_method_name" maxlength="100" autocomplete="off" <?php echo $disabled; ?>>
            </div>
        </form>
    </div>
