<?php
    ...
    $scrapStatus    = $scrapDetails['scrap_status'] ?? 'Pending';

    $disabled = ($scrapStatus === 'Applied') ? 'disabled' : $disabled;
?>
<div class="card mb-10">
    <div class="card-header border-0">
        ...
        <?php
            if ($permissions['delete'] > 0 || ($applyAdjustment['total'] > 0 && $scrapStatus === 'Pending')) {
                ...
                if ($applyAdjustment['total'] > 0 && $scrapStatus === 'Pending') {
                    $action .= '<div class="menu-item px-3">
                                    <a href="javascript:void(0);" class="menu-link px-3" id="complete-scrap">
                                        Complete
                                    </a>
                                </div>';
                }
