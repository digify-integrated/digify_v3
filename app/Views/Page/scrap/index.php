<div class="card mb-6">
                ...
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                    ...
                    <div class="separator border-gray-200"></div>
                        <div class="px-7 py-5">
                            ...
                            <div class="mb-10">
                                <label class="form-label fs-6 fw-semibold" for="filter_by_completed_date">Completed Date:</label>
                                <input class="form-control mb-3" id="filter_by_completed_date" name="filter_by_completed_date" type="text" autocomplete="off" />
                            </div>
                            <div class="mb-10">
                                <label class="form-label fs-6 fw-semibold" for="filter_by_scrap_status">Status:</label>
                                <select id="filter_by_scrap_status" name="filter_by_scrap_status" multiple="multiple" class="form-select" data-control="select2" data-allow-clear="false">
    ...
    <div class="card-body pt-9">
        <div class="table-responsive">
            <table class="table align-middle cursor-pointer table-row-dashed fs-6 gy-5 text-nowrap" id="scrap-table">
                <thead>
