<div class="card mb-10">
    <div class="card-header border-0">
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">Nationality Details</h3>
        </div>
        <?php
    ...
    <div class="card-body">
        <form id="nationality_form" method="post" action="#">
            <?= $security->csrfInput('nationality_form'); ?>
            <div class="fv-row mb-4">
                <label class="fs-6 fw-semibold required form-label mt-3" for="nationality_name">
                    Display Name
                </label>

                <input type="text" class="form-control" id="nationality_name" name="nationality_name" maxlength="100" autocomplete="off" <?php echo $disabled; ?>>
            </div>
        </form>
    </div>
    ...
    <?php
        echo ($permissions['write'] > 0) ? ' <div class="card-footer d-flex justify-content-end py-6 px-9">
                                                ...
                                                <button type="submit" form="nationality_form" class="btn btn-primary" id="submit-data">Save</button>
                                            </div>' : '';
    ?>
</div>
