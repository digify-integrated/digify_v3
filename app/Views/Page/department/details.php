<div class="card mb-10">
    ...
    <div class="card-body">
        <form id="department_form" class="form" method="post" action="#">
            <?= $security->csrfInput('department_form'); ?>
            <div class="fv-row mb-4">
                <label class="fs-6 fw-semibold required form-label mt-3" for="department_name">
                    Display Name
                </label>
    ...
    <?php
        echo ($permissions['write'] > 0) ? '<div class="card-footer d-flex justify-content-end py-6 px-9">
                                                ...
                                                <button type="submit" form="department_form" class="btn btn-primary" id="submit-data">Save Changes</button>
                                            </div>' : '';
    ?>
</div>
