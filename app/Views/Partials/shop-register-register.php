            ...
            <div class="card-body pt-0">
                <div class="hover-scroll-overlay-y pe-6 me-n6" style="max-height: 320px">
                    <div class="border border-dashed border-gray-300 rounded px-7 bg-hover-secondary py-5 mb-2">
                        ...
                        <div class="separator separator-dashed mb-2 mt-2"></div>
                        <div class="row">
                            <div class="col-12">
                                <span class="badge badge-warning text-wrap">12% discount off on P 1,300.00</span>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                <span class="badge badge-danger text-wrap text-start"> Note: No onion asdasdas</span>
                            </div>
                        </div>
                    </div>
                    <div class="border border-dashed border-gray-300 rounded px-7 bg-hover-secondary py-5 mb-2">
