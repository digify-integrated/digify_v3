...
INSERT INTO menu_item (menu_item_name, menu_item_url, menu_item_icon, app_module_id, app_module_name, parent_id, parent_name, table_name, folder_name, order_sequence)
VALUES
('App Module', 'app-module.php', '', 1, 'Settings', 0, '', 'app_module', 'app-module', 1),
('Settings', '', '', 1, 'Settings', 0, '', '', '', 80),
('Users & Companies', '', '', 1, 'Settings', 0, '', '', '', 21),
('User Account', 'user-account.php', 'ki-outline ki-user', 1, 'Settings', 3, 'Users & Companies', 'user_account', 'user-account', 21),
('Company', 'company.php', 'ki-outline ki-shop', 1, 'Settings', 3, 'Users & Companies', 'company', 'company', 3),
('Role', 'role.php', '', 1, 'Settings', NULL, NULL, 'role', 'role', 3),
('User Interface', '', '', 1, 'Settings', NULL, NULL, '', '', 16),
('Menu Item', 'menu-item.php', 'ki-outline ki-data', 1, 'Settings', 7, 'User Interface', 'menu_item', 'menu-item', 2),
('System Action', 'system-action.php', 'ki-outline ki-key-square', 1, 'Settings', 7, 'User Interface', 'system_action', 'system-action', 3),
...
('Country', 'country.php', '', 1, 'Settings', 12, 'Localization', 'country', 'country', 3),
('State', 'state.php', '', 1, 'Settings', 12, 'Localization', 'state', 'state', 19),
('City', 'city.php', '', 1, 'Settings', 12, 'Localization', 'city', 'city', 3),
('Currency', 'currency.php', '', 1, 'Settings', 12, 'Localization', 'currency', 'currency', 3),
('Nationality', 'nationality.php', '', 1, 'Settings', 12, 'Localization', 'nationality', 'nationality', 20),
('Data Classification', '', 'ki-outline ki-file-up', 1, 'Settings', 11, 'Configurations', '', '', 4),
('File Type', 'file-type.php', '', 1, 'Settings', 18, 'Data Classification', 'file_type', 'file-type', 6),
('File Extension', 'file-extension.php', '', 1, 'Settings', 18, 'Data Classification', 'file_extension', 'file-extension', 6),
('Upload Setting', 'upload-setting.php', 'ki-outline ki-exit-up', 1, 'Settings', 2, 'Settings', 'upload_setting', 'upload-setting', 21),
('Notification Setting', 'notification-setting.php', 'ki-outline ki-notification', 1, 'Settings', 2, 'Settings', 'notification_setting', 'notification-setting', 14),
('Banking', '', 'ki-outline ki-bank', 1, 'Settings', 11, 'Configurations', '', '', 2),
('Bank', 'bank.php', '', 1, 'Settings', 23, 'Banking', 'bank', 'bank', 1),
('Bank Account Type', 'bank-account-type.php', '', 1, 'Settings', 23, 'Banking', 'bank_account_type', 'bank-account-type', 2),
('Contact Information', '', 'ki-outline ki-address-book', 1, 'Settings', 11, 'Configurations', '', '', 3),
('Address Type', 'address-type.php', '', 1, 'Settings', 26, 'Contact Information', 'address_type', 'address-type', 1),
('Contact Information Type', 'contact-information-type.php', 'ki-outline ki-abstract', 1, 'Settings', 26, 'Contact Information', 'contact_information_type', 'contact-information-type', 3),
('Language Settings', '', 'ki-outline ki-note-2', 1, 'Settings', 11, 'Configurations', '', '', 12),
('Language', 'language.php', '', 1, 'Settings', 29, 'Language Settings', 'language', 'language', 1),
('Language Proficiency', 'language-proficiency.php', '', 1, 'Settings', 29, 'Language Settings', 'language_proficiency', 'language-proficiency', 2),
('Profile Attribute', '', 'ki-outline ki-people', 1, 'Settings', 11, 'Configurations', '', '', 16),
('Blood Type', 'blood-type.php', '', 1, 'Settings', 32, 'Profile Attribute', 'blood_type', 'blood-type', 2),
('Civil Status', 'civil-status.php', '', 1, 'Settings', 32, 'Profile Attribute', 'civil_status', 'civil-status', 3),
('Educational Stage', 'educational-stage.php', '', 1, 'Settings', 32, 'Profile Attribute', 'educational_stage', 'educational-stage', 5),
('Gender', 'gender.php', '', 1, 'Settings', 32, 'Profile Attribute', 'gender', 'gender', 7),
('Credential Type', 'credential-type.php', '', 1, 'Settings', 32, 'Profile Attribute', 'credential_type', 'credential-type', 3),
('Relationship', 'relationship.php', '', 1, 'Settings', 32, 'Profile Attribute', 'relationship', 'relationship', 18),
('Religion', 'religion.php', '', 1, 'Settings', 32, 'Profile Attribute', 'religion', 'religion', 19),
('Employee', 'employee.php', '', 2, 'Employee', 0, '', 'employee', 'employee', 1),
('HR Configurations', '', '', 2, 'Employee', NULL, '', '', '', 99),
('Department', 'department.php', 'ki-outline ki-data', 2, 'Employee', 41, 'HR Configurations', 'department', 'department', 4),
('Departure Reason', 'departure-reason.php', 'ki-outline ki-user-square', 2, 'Employee', 41, 'HR Configurations', 'departure_reason', 'departure-reason', 4),
('Employment Location Type', 'employment-location-type.php', 'ki-outline ki-route', 2, 'Employee', 41, 'HR Configurations', 'employment_location_type', 'employment-location-type', 5),
('Employment Type', 'employment-type.php', 'ki-outline ki-briefcase', 2, 'Employee', 41, 'HR Configurations', 'employment_type', 'employment-type', 5),
('Job Position', 'job-position.php', 'ki-outline ki-questionnaire-tablet', 2, 'Employee', 41, 'HR Configurations', 'job_position', 'job-position', 10),
('Work Location', 'work-location.php', 'ki-outline ki-geolocation', 2, 'Employee', 41, 'HR Configurations', 'work_location', 'work-location', 23),
('Employee Document Type', 'employee-document-type.php', 'ki-outline ki-folder', 2, 'Employee', 41, 'HR Configurations', 'employee_document_type', 'employee-document-type', 5),
('Inventory Configuration', '', '', 4, 'Inventory', 0, '', '', '', 99),
('Attribute', 'attribute.php', 'ki-outline ki-more-2', 4, 'Inventory', 49, 'Inventory Configuration', 'attribute', 'attribute', 1),
('Product Category', 'product-category.php', 'ki-outline ki-data', 4, 'Inventory', 49, 'Inventory Configuration', 'product_category', 'product-category', 16),
('Supplier', 'supplier.php', 'ki-outline ki-logistic', 4, 'Inventory', 49, 'Inventory Configuration', 'supplier', 'supplier', 19),
('Taxes', '', 'ki-outline ki-percentage', 1, 'Settings', 11, 'Configurations', '', '', 20),
('Tax', 'tax.php', '', 1, 'Settings', 53, 'Taxes', 'tax', 'tax', 1),
('Product Measurement', '', 'ki-outline ki-graph', 4, 'Inventory', 49, 'Inventory Configuration', '', '', 16),
('Unit', 'unit.php', '', 4, 'Inventory', 55, 'Product Measurement', 'unit', 'unit', 1),
('Unit Type', 'unit-type.php', '', 4, 'Inventory', 55, 'Product Measurement', 'unit_type', 'unit-type', 2),
('Warehouse Management', '', 'ki-outline ki-home-3', 4, 'Inventory', 49, 'Inventory Configuration', '','', 23),
('Warehouse', 'warehouse.php', '', 4, 'Inventory', 58, 'Warehouse Management', 'warehouse', 'warehouse', 1),
('Warehouse Type', 'warehouse-type.php', '', 4, 'Inventory', 58, 'Warehouse Management', 'warehouse_type', 'warehouse-type', 2),
('Products', '', '', 4, 'Inventory', 0, '', '', '', 1),
('Product', 'product.php', 'ki-outline ki-parcel', 4, 'Inventory', 61, 'Products', 'product', 'product', 1),
('Product Variant', 'product-variant.php', 'ki-outline ki-lots-shopping', 4, 'Inventory', 61, 'Products', 'product', 'product-variant', 2),
('Pricelist', 'pricelist.php', 'ki-outline ki-tablet-text-down', 4, 'Inventory', 61, 'Products', 'product_pricelist', 'pricelist', 3),
('Inventory Operations', '', '', 4, 'Inventory', 0, '', '', '', 2),
('Inventory Transfer', '', 'ki-outline ki-courier', 4, 'Inventory', 65, 'Inventory Operations', '', '', 1),
('Receipts', 'receipts.php', '', 4, 'Inventory', 66, 'Inventory Transfer', '', 'receipts', 18),
('Delivery', 'delivery.php', '', 4, 'Inventory', 66, 'Inventory Transfer', '', 'delivery', 4),
('Inventory Adjustments', '', 'ki-outline ki-setting-4', 4, 'Inventory', 65, 'Inventory Operations', '', '', 2),
('Physical Inventory', 'physical-inventory.php', '', 4, 'Inventory', 69, 'Inventory Adjustments', '', 'physical-inventory', 16),
('Scrap', 'scrap.php', '', 4, 'Inventory', 69, 'Inventory Adjustments', '', 'scrap', 19),
('Inventory Procurement', '', 'ki-outline ki-cheque', 4, 'Inventory', 65, 'Inventory Operations', '', '', 3),
('Replenishment', 'replenishment.php', '', 4, 'Inventory', 72, 'Inventory Procurement', '', 'replenishment', 18),
('Scrap Reason', 'scrap-reason.php', 'ki-outline ki-trash-square', 4, 'Inventory', 49, 'Inventory Configuration', 'scrap_reason', 'scrap-reason', 12);
...
('Apply Scrap Adjustment', 'Access to apply scrap adjustment.');
...
(1, 'Super Admin', 22, 'Apply Scrap Adjustment', 1);
...
CREATE INDEX idx_tax_tax_calculation ON tax(tax_calculation);
...
CREATE TABLE discount_type (
  discount_type_id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE shop_discounts (
  ...
  shop_name VARCHAR(200) NOT NULL,
	...
	discount_type_name VARCHAR(100) NOT NULL,
	automatic_application ENUM('Yes','No') DEFAULT 'No',
  created_date DATETIME DEFAULT CURRENT_TIMESTAMP,
  last_updated DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  last_log_by INT UNSIGNED DEFAULT 1,
  FOREIGN KEY (shop_id) REFERENCES shop(shop_id),
